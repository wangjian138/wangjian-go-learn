...
[![goproxy](https://goproxy.cn/stats/shorturl/go-zero/badges/download-count.svg)](https://goproxy.cn/stats/shorturl/go-zero/badges/download-count.svg)
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u shorturl/go-zero
```
...
1. 安装 goctl 工具
    ...
    ```shell
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u shorturl/go-zero/tools/goctl
    ```
...
项目地址：[https://shorturl/go-zero](https://shorturl/go-zero)
