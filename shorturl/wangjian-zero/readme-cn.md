...
[![goproxy](https://goproxy.cn/stats/shorturl/wangjian-zero/badges/download-count.svg)](https://goproxy.cn/stats/shorturl/wangjian-zero/badges/download-count.svg)
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u shorturl/wangjian-zero
```
...
0. 完整示例请查看
    ...
    [快速构建高并发微服务](https://shorturl/zero-doc/blob/main/doc/shorturl.md)

    [快速构建高并发微服务 - 多 RPC 版](https://shorturl/zero-doc/blob/main/docs/zero/bookstore.md)
...
1. 安装 goctl 工具
    ...
    ```shell
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u shorturl/wangjian-zero/tools/goctl
    ```
...
2. 快速生成 api 服务
    ...
    编写业务代码：
      ...
      * api 文件定义了服务对外暴露的路由，可参考 [api 规范](https://shorturl/zero-doc/blob/main/doc/goctl.md)
...
* awesome 系列（更多文章见『微服务实践』公众号）
  * [快速构建高并发微服务](https://shorturl/zero-doc/blob/main/doc/shorturl.md)
  * [快速构建高并发微服务 - 多 RPC 版](https://shorturl/zero-doc/blob/main/docs/zero/bookstore.md)
  * [goctl 使用帮助](https://shorturl/zero-doc/blob/main/doc/goctl.md)
...
项目地址：[https://shorturl/wangjian-zero](https://shorturl/wangjian-zero)
