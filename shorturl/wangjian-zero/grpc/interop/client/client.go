...
import (
	...
	_ "shorturl/wangjian-zero/grpc/balancer/grpclb"
	"shorturl/wangjian-zero/grpc/credentials"
	"shorturl/wangjian-zero/grpc/credentials/alts"
	"shorturl/wangjian-zero/grpc/credentials/google"
	"shorturl/wangjian-zero/grpc/credentials/oauth"
	"shorturl/wangjian-zero/grpc/grpclog"
	"shorturl/wangjian-zero/grpc/interop"
	testpb "shorturl/wangjian-zero/grpc/interop/grpc_testing"
