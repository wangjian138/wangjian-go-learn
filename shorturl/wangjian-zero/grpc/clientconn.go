...
import (
	...
	_ "shorturl/wangjian-zero/grpc/balancer/roundrobin"           // To register roundrobin.
	_ "shorturl/wangjian-zero/grpc/internal/resolver/dns"         // To register dns resolver.
	_ "shorturl/wangjian-zero/grpc/internal/resolver/passthrough" // To register passthrough resolver.
)
...
func (cc *ClientConn) updateResolverState(s resolver.State, err error) error {
	...
	cc.mu.Lock()
	// AuthCheck if the ClientConn is already closed. Some fields (e.g.
