...
import (
	...
	_ "shorturl/wangjian-zero/grpc/balancer/grpclb" // grpclb for config parsing.
	rlspb "shorturl/wangjian-zero/grpc/balancer/rls/internal/proto/grpc_lookup_v1"
	_ "shorturl/wangjian-zero/grpc/internal/resolver/passthrough" // passthrough resolver.
)
