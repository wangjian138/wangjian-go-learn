...
import (
	...
	profsvc "shorturl/wangjian-zero/grpc/profiling/service"
	pb "shorturl/wangjian-zero/grpc/examples/features/proto/echo"
)
...
```bash
$ go run shorturl/wangjian-zero/grpc/profiling/cmd \
...
```go
import (
	"shorturl/wangjian-zero/grpc/profiling"
)
...
##### Is `shorturl/wangjian-zero/grpc/profiling/cmd` the canonical implementation of a client that can talk to the profiling service?
