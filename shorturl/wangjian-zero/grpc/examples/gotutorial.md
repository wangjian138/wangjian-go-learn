...
```shell
$ go get shorturl/wangjian-zero/grpc
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/shorturl/wangjian-zero/grpc/examples/route_guide
```
...
`$GOPATH/src/shorturl/wangjian-zero/grpc/examples/route_guide`, simply:
