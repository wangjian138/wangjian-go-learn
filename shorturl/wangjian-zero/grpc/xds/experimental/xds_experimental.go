...
import (
	_ "shorturl/wangjian-zero/grpc/xds/internal/balancer" // Register the balancers.
	_ "shorturl/wangjian-zero/grpc/xds/internal/resolver" // Register the xds_resolver
)
