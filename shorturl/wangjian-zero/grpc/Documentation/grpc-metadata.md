...
A metadata can be created using package [metadata](https://godoc.org/shorturl/wangjian-zero/grpc/metadata).
...
Header and trailer sent along with a unary call can be retrieved using function [Header](https://godoc.org/shorturl/wangjian-zero/grpc#Header) and [Trailer](https://godoc.org/shorturl/wangjian-zero/grpc#Trailer) in [CallOption](https://godoc.org/shorturl/wangjian-zero/grpc#CallOption):
...
Header and trailer can be retrieved from the returned stream using function `Header` and `Trailer` in interface [ClientStream](https://godoc.org/shorturl/wangjian-zero/grpc#ClientStream):
...
To send header and trailer to client in unary call, the server can call [SendHeader](https://godoc.org/shorturl/wangjian-zero/grpc#SendHeader) and [SetTrailer](https://godoc.org/shorturl/wangjian-zero/grpc#SetTrailer) functions in module [grpc](https://godoc.org/shorturl/wangjian-zero/grpc).
...
For streaming calls, header and trailer can be sent using function `SendHeader` and `SetTrailer` in interface [ServerStream](https://godoc.org/shorturl/wangjian-zero/grpc#ServerStream):
