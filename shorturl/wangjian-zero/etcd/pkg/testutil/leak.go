...
running(leaking) after all tests.
	...
	import "shorturl/wangjian-zero/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "shorturl/wangjian-zero/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "shorturl/wangjian-zero/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
