...
[![GoDoc](https://godoc.org/shorturl/wangjian-zero/etcd/client?status.png)](https://godoc.org/shorturl/wangjian-zero/etcd/client)
...
```bash
go get shorturl/wangjian-zero/etcd/client
```
