...
- Upgrade [`shorturl/wangjian-zero/grpc`](https://github.com/grpc/grpc-go/releases) from [**`v1.23.1`**](https://github.com/grpc/grpc-go/releases/tag/v1.23.1) to [**`v1.24.0`**](https://github.com/grpc/grpc-go/releases/tag/v1.24.0).
...
- Upgrade [`shorturl/wangjian-zero/grpc`](https://github.com/grpc/grpc-go/releases) from [**`v1.23.0`**](https://github.com/grpc/grpc-go/releases/tag/v1.23.0) to [**`v1.23.1`**](https://github.com/grpc/grpc-go/releases/tag/v1.23.1).
...
- Move [`"github.com/coreos/etcd"`](https://github.com/etcd-io/etcd/issues/9965) to [`"github.com/etcd-io/etcd"`](https://github.com/etcd-io/etcd/issues/9965).
  - Change import path to `"shorturl/wangjian-zero/etcd"`.
  - e.g. `import "shorturl/wangjian-zero/etcd/raft"`.
...
- Deprecated [`grpc.ErrClientConnClosing`](https://github.com/etcd-io/etcd/pull/10981).
  ...
  - Use `clientv3.IsConnCanceled(error)` or `shorturl/wangjian-zero/grpc/status.FromError(error)` instead.
...
- Move internal packages to `etcdserver`.
  - `"github.com/coreos/etcd/alarm"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/v3alarm"`.
  - `"github.com/coreos/etcd/compactor"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/v3compactor"`.
  - `"github.com/coreos/etcd/discovery"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/v2discovery"`.
  - `"github.com/coreos/etcd/etcdserver/auth"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/v2auth"`.
  - `"github.com/coreos/etcd/etcdserver/membership"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/membership"`.
  - `"github.com/coreos/etcd/etcdserver/stats"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/v2stats"`.
  - `"github.com/coreos/etcd/error"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/v2error"`.
  - `"github.com/coreos/etcd/rafthttp"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/rafthttp"`.
  - `"github.com/coreos/etcd/snap"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/snap"`.
  - `"github.com/coreos/etcd/store"` to `"shorturl/wangjian-zero/etcd/etcdserver/api/v2store"`.
...
- Upgrade [`shorturl/wangjian-zero/grpc`](https://github.com/grpc/grpc-go/releases) from [**`v1.7.5`**](https://github.com/grpc/grpc-go/releases/tag/v1.7.5) to [**`v1.23.0`**](https://github.com/grpc/grpc-go/releases/tag/v1.23.0).
