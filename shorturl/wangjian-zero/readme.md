...
0. full examples can be checked out from below:
     ...
     [Rapid development of microservice systems](https://shorturl/zero-doc/blob/main/doc/shorturl-en.md)

     [Rapid development of microservice systems - multiple RPCs](https://shorturl/zero-doc/blob/main/doc/bookstore-en.md)
...
* [Rapid development of microservice systems](https://shorturl/zero-doc/blob/main/doc/shorturl-en.md)
* [Rapid development of microservice systems - multiple RPCs](https://shorturl/zero-doc/blob/main/docs/zero/bookstore-en.md)
